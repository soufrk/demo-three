...
/**
 * Appending result with each recursion. But this leads to all unwanted results
 * being appended,
 * 
...
public class Lcs4 {
	...
	if (o1.isSingleChar && o2.isSingleChar) {
	    ...
	    // result = findLcs(o1.isSingleChar?o1.lastChar:o1.value,
	    // o2.isSingleChar?o2.lastChar:o2.lastSubString);
	}
	return result;
    }
